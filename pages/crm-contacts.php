                            ...
                            <div class="card custom-card">
                                <div class="card-header d-flex align-items-center justify-content-between flex-wrap gap-3">
                                    <div class="card-title">
                                        Contacts<span class="badge bg-pink rounded ms-1 fs-12 align-middle">28</span>
                                    </div>
                                    <div class="d-flex flex-wrap gap-2">
                                        ...
                                        <button class="btn btn-success btn-sm">Export As CSV</button>
                                        <div class="dropdown">
                                            <a href="javascript:void(0);" class="btn btn-warning btn-sm btn-wave waves-effect waves-light" data-bs-toggle="dropdown" aria-expanded="false">
                                        ...
                                        <table class="table text-nowrap">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="crm-contact">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center flex-wrap gap-1">
                                                            <span class="badge bg-pink-transparent">LostCustomer</span>
                                                ...
                                                <tr class="crm-contact">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            ...
                                                            <div>
                                                                <a data-bs-toggle="offcanvas" href="#offcanvasExample"
                                                                role="button" aria-controls="offcanvasExample"><span class="d-block fw-medium">Arjun Arora</span></a>
                                                    ...
                                                    <td>
                                                        <div>
                                                            <span class="d-block mb-1"><i class="ri-mail-line me-2 align-middle fs-14 text-muted"></i>aroraarjun345@gmail.com</span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                ...
                                                <tr class="crm-contact">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center flex-wrap gap-1">
                                                            <span class="badge bg-primary-transparent">New Lead</span>
                                                            <span class="badge bg-danger-transparent">Lost Customer</span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="btn-list">
                            ...
                            <div class="d-sm-flex align-items-top p-4 border-bottom border-block-end-dashed main-profile-cover">
                                ...
                                <div class="flex-fill main-profile-info">
                                    ...
                                    <p class="fs-12 mb-4 op-5">  
                                        <span class="me-3 d-inline-flex"><i class="ri-building-line me-1 align-middle"></i>Georgia</span> 
