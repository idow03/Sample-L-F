...
<?php ob_start(); ?>
                    ...
                    <div class="my-4 page-header-breadcrumb d-flex align-items-center justify-content-between flex-wrap gap-2">
                        <div>
                            <h1 class="page-title fw-medium fs-18 mb-2">Edit Products</h1>
                            <div class="">
                                <nav>
                            ...
                            <div class="card custom-card">
                                <div class="card-body add-products">
                                    <div class="row gx-5">
                                        ...
                                        <div class="col-xxl-6 col-xl-12 col-lg-12 col-md-6">
                                            <div class="card custom-card shadow-none mb-0 border-0 mt-3 mt-xxl-0">
                                                <div class="card-body p-0">
                                                    <div class="row gy-3">
                                                        <div class="col-xl-4">
                                ...
                                <div class="card-footer border-top border-block-start-dashed d-sm-flex justify-content-end">
                                    <button class="btn btn-secondary-light me-2 mb-2 mb-sm-0">Add Product<i class="bi bi-plus-lg ms-2"></i></button>
...
<?php ob_start(); ?>
        ...
        <script src="<?php echo $baseUrl; ?>/assets/js/edit-products.js"></script>
