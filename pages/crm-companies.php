                            ...
                            <div class="card custom-card">
                                <div class="card-header justify-content-between">
                                    <div class="card-title">
                                        Companies <span class="badge bg-pink rounded ms-1 fs-12 align-middle">14</span>
                                    </div>
                                    <div class="d-flex flex-wrap gap-2">
                                        ...
                                        <button class="btn btn-success btn-sm btn-wave">Export As CSV</button>
                                        <div class="dropdown">
                                            <a href="javascript:void(0);" class="btn btn-warning btn-sm btn-wave" data-bs-toggle="dropdown" aria-expanded="false">
                                        ...
                                        <table class="table text-nowrap">
                                            ...
                                            <tbody>
                                                <tr class="crm-contact">
                                                    ...
                                                    <td>
                                                        <div>
                                                            <span class="d-block mb-1"><i class="ri-mail-line me-2 align-middle fs-14 text-muted d-inline-block"></i>spruko2981@gmail.com</span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div>
                                                ...
                                                <tr class="crm-contact">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            ...
                                                            <div>
                                                                <span class="d-block fw-medium">Arjun Arora</span>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
