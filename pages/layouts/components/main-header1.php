								...
								<ul class="list-unstyled mb-0" id="header-cart-items-scroll">
										...
										<div class="d-flex align-items-center cart-dropdown-item gap-3">
											<div class="lh-1">
												<span class="avatar avatar-md bg-gray-300">
													<img src="<?php echo $baseUrl; ?>/assets/images/ecommerce/jpg/1.jpg" alt="Wireless Headphones">
												</span>
											</div>
											<div class="flex-fill">
												<div class="d-flex align-items-center justify-content-between mb-0">
													<div class="mb-0 fs-13 fw-medium">
														<a href="product-details.php">Wireless Headphones</a>
									...
									<li class="dropdown-item">
										<div class="d-flex align-items-center cart-dropdown-item gap-3">
											<div class="lh-1">
												<span class="avatar avatar-md bg-gray-300">
													<img src="<?php echo $baseUrl; ?>/assets/images/ecommerce/jpg/2.jpg" alt="Smartwatch">
												</span>
											</div>
											<div class="flex-fill">
												<div class="d-flex align-items-center justify-content-between mb-0">
													<div class="mb-0 fs-13 fw-medium">
														<a href="product-details.php">Smart Fitness Watch</a>
														<div class="fs-11 mt-1 d-flex gap-2 flex-wrap">
															<div class="text-default"><span class="text-primary">Qty :</span> 1</div>
															<div class="text-default"><span class="text-muted op-5">|</span></div>
									...
									<li class="dropdown-item">
										<div class="d-flex align-items-center cart-dropdown-item gap-3">
											<div class="lh-1">
												<span class="avatar avatar-md bg-gray-300">
													<img src="<?php echo $baseUrl; ?>/assets/images/ecommerce/jpg/5.jpg" alt="Gaming Laptop">
												</span>
											</div>
											<div class="flex-fill">
												<div class="d-flex align-items-center justify-content-between mb-0">
													<div class="mb-0 fs-13 fw-medium">
														<a href="product-details.php">Modern Laptop</a><span class="fs-9 ms-1 fw-medium text-success"><i class="ri-discount-percent-line fs-13"></i> 20off</span>
														<div class="fs-11 mt-1 d-flex gap-2 flex-wrap">
															<div class="text-default"><span class="text-primary">Qty :</span> 1</div>
															<div class="text-default"><span class="text-muted op-5">|</span></div>
															<div class="text-default"><span class="text-secondary">Color :</span> Black</div>
									...
									<li class="dropdown-item">
										<div class="d-flex align-items-center cart-dropdown-item gap-3">
											<div class="lh-1">
												<span class="avatar avatar-md bg-gray-300">
													<img src="<?php echo $baseUrl; ?>/assets/images/ecommerce/jpg/7.jpg" alt="Bluetooth Speaker">
												</span>
											</div>
											<div class="flex-fill">
												<div class="d-flex align-items-center justify-content-between mb-0">
													<div class="mb-0 fs-13 fw-medium">
														<a href="product-details.php">Portable Bluetooth Speaker</a>
														<div class="fs-11 mt-1 d-flex gap-2 flex-wrap">
															<div class="text-default"><span class="text-primary">Qty :</span> 1</div>
															<div class="text-default"><span class="text-muted op-5">|</span></div>
									...
									<li class="dropdown-item">
										<div class="d-flex align-items-center cart-dropdown-item gap-3">
											<div class="lh-1">
												<span class="avatar avatar-md bg-gray-300">
													<img src="<?php echo $baseUrl; ?>/assets/images/ecommerce/jpg/8.jpg" alt="Fitness Tracker">
												</span>
											</div>
											<div class="flex-fill">
												<div class="d-flex align-items-center justify-content-between mb-0">
													<div class="mb-0 fs-13 fw-medium">
														<a href="product-details.php">Fitness Tracker</a>
														<div class="fs-11 mt-1 d-flex gap-2 flex-wrap">
															<div class="text-default"><span class="text-primary">Qty :</span> 1</div>
															<div class="text-default"><span class="text-muted op-5">|</span></div>
									...
									<li class="dropdown-item">
										<div class="d-flex align-items-center cart-dropdown-item gap-3">
											<div class="lh-1">
												<span class="avatar avatar-md bg-gray-300">
													<img src="<?php echo $baseUrl; ?>/assets/images/ecommerce/jpg/3.jpg" alt="DSLR Camera">
												</span>
											</div>
											<div class="flex-fill">
												<div class="d-flex align-items-center justify-content-between mb-0">
													<div class="mb-0 fs-13 fw-medium">
														<a href="product-details.php">DSLR Camera</a>
														<div class="fs-11 mt-1 d-flex gap-2 flex-wrap">
															<div class="text-default"><span class="text-primary">Qty :</span> 1</div>
															<div class="text-default"><span class="text-muted op-5">|</span></div>
															<div class="text-default"><span class="text-secondary">Color :</span> Black</div>
						...
						<li class="header-element dropdown">
							...
							<a href="javascript:void(0);" class="header-link dropdown-toggle" id="mainHeaderProfile" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
								<div class="d-flex align-items-center">
									<div>
										<img src="<?php echo $baseUrl; ?>/assets/images/faces/10.jpg" alt="img" class="avatar avatar-sm avatar-rounded">
									</div>
								</div>
							</a>
							<!-- End::header-link|dropdown-toggle -->
							<ul class="main-header-dropdown dropdown-menu pt-0 overflow-hidden header-profile-dropdown dropdown-menu-end" aria-labelledby="mainHeaderProfile">
								...
								<li><a class="dropdown-item d-flex align-items-center" href="profile.php"><i class="ri-user-line fs-15 me-2 text-gray fw-normal"></i>Profile</a></li>
								<li><a class="dropdown-item d-flex align-items-center" href="mail.php"><i class="ri-chat-1-line fs-15 me-2 text-gray fw-normal"></i>Messages <span class="badge bg-pink ms-auto">02</span></a></li>
								<li><a class="dropdown-item d-flex align-items-center" href="profile.php"><i class="ri-group-line fs-15 me-2 text-gray fw-normal"></i>Friends</a></li>
								<li><a class="dropdown-item d-flex align-items-center" href="mail-settings.php"><i class="ri-user-settings-line fs-15 me-2 text-gray fw-normal"></i>Account Settings</a></li>
								<li> <hr class="dropdown-divider"> </li>
								<li><a class="dropdown-item d-flex align-items-center" href="sign-in-cover.php"><i class="ri-logout-circle-line fs-15 me-2 text-gray fw-normal"></i>Sign Out</a></li>
							</ul>
						</li>  
						<!-- End::header-element -->
