											...
											<div class="flex-fill">
												<div class="d-flex align-items-center justify-content-between mb-0">
													<div class="mb-0 fs-13 fw-medium">
														<a href="cart.php">Wireless Headphones</a>
									...
									<li class="dropdown-item">
										<div class="d-flex align-items-center cart-dropdown-item gap-3">
											...
											<div class="flex-fill">
												<div class="d-flex align-items-center justify-content-between mb-0">
													<div class="mb-0 fs-13 fw-medium">
														<a href="cart.php">Smart Fitness Watch</a>
														<div class="fs-11 mt-1 d-flex gap-2 flex-wrap">
															<div class="text-default"><span class="text-primary">Qty :</span> 1</div>
															<div class="text-default"><span class="text-muted op-5">|</span></div>
									...
									<li class="dropdown-item">
										<div class="d-flex align-items-center cart-dropdown-item gap-3">
											...
											<div class="flex-fill">
												<div class="d-flex align-items-center justify-content-between mb-0">
													<div class="mb-0 fs-13 fw-medium">
														<a href="cart.php">Modern Laptop</a><span class="fs-9 ms-1 fw-medium text-success"><i class="ri-discount-percent-line fs-13"></i> 20off</span>
														<div class="fs-11 mt-1 d-flex gap-2 flex-wrap">
															<div class="text-default"><span class="text-primary">Qty :</span> 1</div>
															<div class="text-default"><span class="text-muted op-5">|</span></div>
															<div class="text-default"><span class="text-secondary">Color :</span> Black</div>
									...
									<li class="dropdown-item">
										<div class="d-flex align-items-center cart-dropdown-item gap-3">
											...
											<div class="flex-fill">
												<div class="d-flex align-items-center justify-content-between mb-0">
													<div class="mb-0 fs-13 fw-medium">
														<a href="cart.php">Portable Bluetooth Speaker</a>
														<div class="fs-11 mt-1 d-flex gap-2 flex-wrap">
															<div class="text-default"><span class="text-primary">Qty :</span> 1</div>
															<div class="text-default"><span class="text-muted op-5">|</span></div>
									...
									<li class="dropdown-item">
										<div class="d-flex align-items-center cart-dropdown-item gap-3">
											...
											<div class="flex-fill">
												<div class="d-flex align-items-center justify-content-between mb-0">
													<div class="mb-0 fs-13 fw-medium">
														<a href="cart.php">Fitness Tracker</a>
														<div class="fs-11 mt-1 d-flex gap-2 flex-wrap">
															<div class="text-default"><span class="text-primary">Qty :</span> 1</div>
															<div class="text-default"><span class="text-muted op-5">|</span></div>
